"""Grafické rozhraní pro Klondike Solitaire

Potřebuje knihovnu Pyglet, která se dá nainstalovat pomocí:

    python -m pip install pyglet

Ovládá se buď klávesnicí, nebo klikáním myší. (Ne přetažením, pro jednoduchost.)
"""
